...
<%
      String username=request.getParameter("username");
            ...
            Class.forName("com.mysql.jdbc.Driver");
              ...
              PreparedStatement st2=con.prepareStatement("update student set enrollment=? , branch=? , current_year=? , passing_year=?, email=? ,contact_no=?,address=?,course=?,password=?,confirm=? where username=?");
       ...
       response.sendRedirect("account.html");
                 { %> <script language="javascript"> alert("Updated and saved successfully !!!! "); //Java Script alert message </script> <% }
